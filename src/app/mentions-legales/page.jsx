    ...
    return (
        <>
            ...
            <section className="w-[80%] mx-auto p-3 md:p-6">
                <p>Conformément aux dispositions de la loi n° 2004-575 du 21 juin 2004 pour la confiance en l'économie numérique, il est précisé aux utilisateurs du site USD Basket l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi.</p>
                <H1 title='Edition du site' className='!text-black !text-left my-3' />
                <p>Le présent site, accessible à l’URL https://www.usdcbasket.com/ (le « Site »), est édité par : Teddy Boirin, de nationalité Française (France), né le 17/09/1997,</p>
                ...
                <H1 title='Directeur de publication' className='!text-black !text-left my-3' />
                ...
                <p>
                    Par email : contact@usdcbasket.com
                </p>
                <H1 title='Données personnelles' className='!text-black !text-left my-3' />
                ...
                <p>Certaines photos - images utilisées peuvent être issues du site <a href="https://unsplash.com/">Unsplash</a></p>
            </section>
        </>
    )
}
